 ...
 *
 * This is copied almost entirely from the Google Codelab "Building an augmented reality (AR) application using the WebXR Device API".
 *
 * @see https://github.com/googlecodelabs/ar-with-webxr/blob/7f8b796b546996d522ecd4e22c41d54f58b40778/shared/utils.js
 */
...
class Reticle extends THREE.Object3D {
  ...
  constructor(xrSession, camera) {
    ...
    // once loaded
    this.loader.load( augmentedReality.anchorUrl, texture => { // @todo: use a dynamic value URL for the Anchor.
